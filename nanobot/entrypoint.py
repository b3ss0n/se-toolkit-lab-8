...
class Settings(BaseSettings):
    ...
    nanobot_victorialogs_url: str | None = Field(default=None, alias="NANOBOT_VICTORIALOGS_URL")
    nanobot_victoriatraces_url: str | None = Field(default=None, alias="NANOBOT_VICTORIATRACES_URL")
